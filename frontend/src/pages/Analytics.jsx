      ...
      <Layout title="Analytics">
        <div style={{ ...card, textAlign: "center", padding: 60 }}>
          ...
          <p style={{ fontSize: 14, color: "var(--text-muted)", maxWidth: 400, margin: "0 auto" }}>
            El dashboard de Analytics con KPIs, tendencias y top contenido está disponible en el
            plan Premium.
          </p>
        </div>
      </Layout>
        ...
        <div style={card}>
          ...
          {tendData.length === 0 ? (
            <EmptyState
              icon="📊"
              title="Sin datos"
              description="Publicá contenido para ver tendencias"
            />
          ) : (
      ...
      <div style={card}>
        ...
        {topContenido.length === 0 ? (
          <EmptyState
            ...
            description="Publicá contenido para ver el top"
          />
        ) : (
              ...
              <div style={{ display: "flex", gap: 10, alignItems: "center" }}>
                ...
                <div>
                  <div style={{ fontSize: 13, color: "var(--text)", fontWeight: 500 }}>
                    {p.red_social} — {(p.copy_publicado || "").slice(0, 60)}
                  </div>
                  <div style={{ fontSize: 11, color: "var(--text-muted)" }}>
                    {p.publicado_at?.split("T")[0]}
                  </div>
                </div>
              </div>
