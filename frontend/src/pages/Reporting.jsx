    ...
    <Layout title="Reporting">
      ...
      {detalle && (
        <div>
          <div style={{ ...card, borderColor: "var(--primary)" }}>
            ...
            {detalle.contenido?.comparacion && (
              <div style={{ marginTop: 16 }}>
                <h4
                  style={{ fontSize: 13, fontWeight: 700, marginBottom: 8, color: "var(--text)" }}
                >
                  vs Período anterior
                </h4>
          ...
          <button style={btnSmall} onClick={() => setDetalle(null)}>
            Cerrar detalle
          </button>
        </div>
      )}
      ...
      <div style={card}>
        ...
        {reportes.length === 0 ? (
          <EmptyState
            icon="📋"
            title="Sin reportes"
            description="Generá tu primer reporte de performance"
            action={{ label: "Generar reporte", onClick: generar }}
          />
        ) : (
          reportes.map((r) => (
            <div
            ...
            >
              ...
              <div style={{ display: "flex", gap: 8, alignItems: "center" }}>
                ...
                >
                  {r.enviado ? "Enviado" : "Generado"}
                </span>
                <button style={btnSmall} onClick={() => verDetalle(r.id)}>
                  Ver
                </button>
              </div>
            </div>
