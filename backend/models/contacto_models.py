...
class ContactoMkt(Base):
    ...
    email_empresarial: Mapped[str | None] = mapped_column(Text)
    email_personal: Mapped[str | None] = mapped_column(Text)
    telefono_empresa: Mapped[str | None] = mapped_column(Text)
    telefono_personal: Mapped[str | None] = mapped_column(Text)
