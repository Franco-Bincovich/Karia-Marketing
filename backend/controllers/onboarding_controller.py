...
class OnboardingController:
    ...
    def guardar(self, body: GuardarRespuestasRequest, x_marca_id: Optional[str], current_user: dict) -> dict:
    ...
    def sugerir(self, body: SugerirRequest, x_marca_id: Optional[str], current_user: dict) -> dict:
    ...
    def autocompletar(self, body: AutocompletarRequest, x_marca_id: Optional[str], current_user: dict) -> dict:
    ...
    def completar_paso(self, numero: int, body: PasoRequest, x_marca_id: Optional[str], current_user: dict) -> dict:
    ...
    def actualizar_memoria(self, body: MemoriaUpdateRequest, x_marca_id: Optional[str], current_user: dict) -> dict:
        """Actualiza la memoria de marca manualmente."""
        from repositories import memoria_marca_repository

        return memoria_marca_repository.actualizar(self.db, _marca(x_marca_id), body.datos)

    def memoria_agente(self, agente: str, x_marca_id: Optional[str], current_user: dict) -> dict:
