...
def auditar_sitio(db: Session, marca_id: UUID, url: str) -> list:
    ...
    registrar_auditoria(
        db, accion="auditar_sitio_seo", modulo="seo", marca_id=marca_id,
        recurso_id=url,
...
def _analizar_url(url: str) -> list:
    ...
    try:
        ...
        problemas.append({
            "url": url, "tipo": "velocidad", "severidad": "critico",
...
def _check_velocidad(r, url: str, problemas: list) -> None:
    ...
    if r.elapsed.total_seconds() > 3:
        problemas.append({
            "url": url, "tipo": "velocidad", "severidad": "alto",
...
def _problemas_default(url: str) -> list:
    ...
    return [{
        "url": url, "tipo": "schema", "severidad": "medio",
